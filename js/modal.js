...
const txtProce12 = ['imagens/icones-procedimentos/bioestimulador-colageno.jpg','Bioestimuladores de Colágeno', 'Este é um procedimento que utiliza substâncias que estimulam a produção de colágeno na pele. O colágeno é uma proteína essencial que ajuda a <strong>manter a pele firme e elástica</strong>. Com o tempo, a produção de colágeno diminui, o que pode levar a rugas e flacidez na pele. <br><br>Os bioestimuladores de colágeno ajudam a estimular a produção de colágeno, o que pode <strong>melhorar a aparência da pele</strong>. Este tratamento é especialmente recomendado para pessoas que desejam melhorar a firmeza e a textura da pele.']
